...
public class Purchaser : MonoBehaviour, IStoreListener
    {
        ...
        private static string kProductIDNonConsumable = "noads";                                                  // General handle for the non-consumable product.
        ...
        private static string kProductNameAppleNonConsumable = "roosterrun.noads";      // Apple App Store identifier for the non-consumable product.
        ...
        private static string kProductNameGooglePlayNonConsumable = "roosterrun.noads";     // Google Play Store identifier for the non-consumable product.
